...
subroutine rkf45step(t,y,h)  ! 4-th order Runge-Kutta step
    ...
    contains
        ...
        subroutine deriv(t,h,y,k)   ! derivative
	        ...
	        real(dp) :: r_1 ,r_12, r_2

	        
	        
	        	r_1 = sqrt(dot_product(y(1:3),y(1:3)))
	        	r_2 = sqrt(dot_product(y(7:9),y(7:9)))
			r_12 = sqrt(dot_product(y(7:9)-y(1:3),y(7:9)-y(1:3)))
			

	        f(1:3) = y(4:6)
	        f(4:6) = -grav*mass_sun/r_1**3 * y(1:3) 
	        
	        f(7:9) = y(10:12)
	        f(10:12) = -grav*mass_earth/r_12**3 * (y(7:9)-y(1:3)) - grav*mass_sun/r_2**3 * y(7:9)
